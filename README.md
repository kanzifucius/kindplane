...
```yaml
# yaml-language-server: $schema=https://raw.githubusercontent.com/kanzi/kindplane/main/kindplane.schema.json
```
...
{
  "yaml.schemas": {
    "https://raw.githubusercontent.com/kanzi/kindplane/main/kindplane.schema.json": "kindplane.yaml"
  }
}
```
